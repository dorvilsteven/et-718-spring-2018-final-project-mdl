...
class HighlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post highlights_url, params: { highlight: { clip: @highlight.clip, description: @highlight.description, title: @highlight.title } }
    end
  ...
  test "should update highlight" do
    patch highlight_url(@highlight), params: { highlight: { clip: @highlight.clip, description: @highlight.description, title: @highlight.title } }
